...
function CadastroServico() {
    const [infoServico, setInfoServico] = useState<Servicos>(Object)
    ...
    function adicionarSkill() {
        ...
        if (select === "") {
            ...
            if (skillsSelecionadas.includes(select)) {
                ...
                setInfoServico({ ...infoServico, techs: novaListaSkillsSelecionadas });
                setSkillsSelecionadas(novaListaSkillsSelecionadas)
            }
        }
    }
    ...
    function cadastrarServico(event: any) {
        ...
        api.post("servicos/", infoServico)
            ...
            .catch(error => {
                console.log(error);
                alert("Serviço não foi cadastrado!")
            })
        /* api.delete("servicos/4")
        .then(response => {
            console.log(response)
            alert("Serviço cadastrado!")
        })
                        ...
                        <form className="cad_serv_formulario" onSubmit={cadastrarServico}>
                            <div className="cad_serv_box_input">
                                ...
                                <input
                                    ...
                                    onChange={(event) => setInfoServico({ ...infoServico, nome: event.target.value })}
                                />
                            </div>
                            <div className="cad_serv_box_input">
                                ...
                                <textarea
                                    ...
                                    onChange={(event) => setInfoServico({ ...infoServico, descricao: event.target.value })}
                                ></textarea>
                            </div>
                            <div className="cad_serv_box_input">
                                ...
                                <input
                                    ...
                                    id="proposta"
                                    // onKeyUp={ }
                                    onChange={(event) => setInfoServico({ ...infoServico, valor: event.target.value })}
                                    maxLength={17}
